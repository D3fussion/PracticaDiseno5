...
var nanoqueryFactory = ([
  ...
  const fetcherSymbol = /* @__PURE__ */ Symbol();
  const loading = { loading: true }, notLoading = { loading: false };
  return nanoquery2;
};
var subscribe = (name, fn) => {
...
var nanoquery = nanoqueryFactory(browserCompat);
export {
  nanoquery,
  defaultOnErrorRetry as onErrorRetry
};
//# sourceMappingURL=@nanostores_query.js.map
